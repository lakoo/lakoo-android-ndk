...
RUN wget -q --output-document=android-ndk.zip https://dl.google.com/android/repository/android-ndk-r17c-linux-x86_64.zip && \
	unzip android-ndk.zip && \
	rm -f android-ndk.zip && \
	mv android-ndk-r17c android-ndk-linux
